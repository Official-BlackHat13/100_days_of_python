...
def next_card():
    ...
    canvas.itemconfig(english_text, title=current_card["Magyar"])
...
# english text
english_text = canvas.create_text(400, 230, text=f'English', font=('Ariel', 40, 'italic'))

# magyar text
magyar_text = canvas.create_text(400, 590, text=f'Magyar', font=('Ariel', 40, 'italic'))
...
known_button = Button(image=checkmark_image, highlightthickness=0, bg=BACKGROUND_COLOR, borderwidth=0, command=next_card)
